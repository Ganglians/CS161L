...
#endif
static const char *ng0 = "C:/Users/cathy/Documents/UCR/spring2015/CS161L/lab5/lab5/control_unit.vhd";
...
LAB9:    t1 = ((WORK_P_3583369287) + 1288U);
    t5 = *((char **)t1);
    t6 = xsi_mem_cmp(t5, t2, 6U);
    if (t6 == 1)
        goto LAB4;

LAB10:    t1 = ((WORK_P_3583369287) + 1528U);
    t7 = *((char **)t1);
    t8 = xsi_mem_cmp(t7, t2, 6U);
    if (t8 == 1)
        goto LAB5;

LAB11:    t1 = ((WORK_P_3583369287) + 1648U);
    t9 = *((char **)t1);
    t10 = xsi_mem_cmp(t9, t2, 6U);
    if (t10 == 1)
        goto LAB6;

LAB12:    t1 = ((WORK_P_3583369287) + 1768U);
    t11 = *((char **)t1);
...
extern void work_a_3853510154_3212880686_init()
{
	...
	xsi_register_didat("work_a_3853510154_3212880686", "isim/cs161_processor_isim_beh.exe.sim/work/a_3853510154_3212880686.didat");
